<button @click="window.dispatchEvent(new CustomEvent('openFormsModal'))" {{ $attributes->merge(['class' => 'inline-flex items-center justify-center gap-2 rounded-md bg-alt px-4 py-2 text-base font-bold text-white hover:bg-cta hover:text-black transition-colors duration-200 whitespace-nowrap']) }}>
